                          ...
                          <div class="main">
                              ...
                              <header>
                                <h2 style="color: yellow; width: 98%;">
                                  <marquee class="marquee">  Welcome to Al-Ameen Institite of Information Sciences.. Hosure Road Bangalore 560-027</marquee></h2>
                              ...
                              <div class="row1">
                                ...
                                <?php include('./slide-show/college-ss.php'); ?>                 
  				                  </div>
			              </div>
                  </div>
              </div>
