                      ...
                      <section class="content">
                          <div class="post">
                              <div class="post-inner">
                                <header>
                                  <h2 style="color: yellow;">Staff Department</h2>
                                      <div class="header">
                                        <a href="M-Emp-Notice.php">Notice</a><p>|</p>
                                        <a href="DeleteEmp.php">Delete</a><p>|</p>
                                        <a href="M-Emp-Search.php">Search</a><p>|</p>
                                        <a href="UpdateEmp.php">Update</a><p>|</p>
                                        <a href="M-Emp-New.php">Add New</a><p>|</p>
                              ...
                              <div class="content-area">      
                                <div class="row1">
  		             		                <div class="column1">
    				                            <?php include('StaffModulepage.php'); ?>                 
  				                            </div>
			                           </div>
                              </div>
                              </div>
