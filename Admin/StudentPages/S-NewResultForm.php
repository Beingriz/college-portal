...
<div class="border">
    <div class="form">
               ...
               <h1 style="margin-left: 0%; margin-top: 15px; font-family: serif;">Declare New Results</h1>
                ...
                <form action="#" method="POST" onSubmit="return validateForm(this,arrFormValidation);" enctype="multipart/form-data" id="form2">
                 <table width="70%" border="0" cellspacing="20" cellpadding="0">
                    ...
                    <button align="center" type="submit" name="submit">Add Result</button>
                    </div>
                    </td>
              </table>
                    </form>
...
{ 
 ...
 $filename = $_FILES["fileupload"]["name"];
  ...
  if($res_course!="---Select---" && $res_year!="---Select---" && $res_sem!="---Select---") 
  {
    ...
    {
     $query = "Insert into result values('$Result_id','$date','$res_course','$res_year','$res_sem','$folder')";
                ...
                ?>
                  ...
                  while($field = mysqli_fetch_assoc($check))
                  {
                    echo " <tr>
                          ...
                          <td><a href = 'EditStudentResult.php?id=".$field['Result_ID']."'>Edit</a></td>
                          <td><a href = 'DeleteResult.php?id=".$field['Result_ID']." && Course=".$field['Course']." && Year=".$field['Year']." && id2=".$field['Semister']."'>Delete</a></td>
                          </tr>";
