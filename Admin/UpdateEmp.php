                      ...
                      <section class="content">
                          <div class="post">
                              <div class="post-inner">
                                <header>
                                  <h2 style="color: yellow; width: 35%;"> <marquee class="marquee">Update Staff</marquee></h2>
                                      <div class="header">
                              ...
                              <div class="content-area">      
                                <div class="row1">
  		             		                <div class="column1">
                                       <!-- <h2>Update Staff Form is Note Yet Desing</h2><br>
                                        <h2>Please Desing Emp-UpdateForm</h2> -->
    				                            <?php include('./EmployeePages/Emp-UpdateForm1.php'); ?>                 
  				                            </div>
			                           </div>
                              </div>
                              </div>
