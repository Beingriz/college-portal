...
<div class="row">
	<div class="colun">
		<table style="background: slateblue">
			...
			<tr><td><label style="color: white">BCA Students</label></td>
				<td><label style="font-family: serif; font-size: 30px;"><?php echo $bca_count?></label></td>
			</tr>
		</table>
		<table style="background: orange">
			...
			<tr><td><label style="color: white">MCA Students</label></td>
				<td><label style="font-family: serif; font-size: 30px;"><?php echo $mca_count?></label></td>
			</tr>
		</table>
		<table style="background: skyblue">
			...
			<tr><td><label style="color: white">BCA Lecturer</label></td>
				<td><label style="font-family: serif; font-size: 30px;"><?php echo $bcas_count?></label></td>
			</tr>
		</table>
		<table style="background: violet">
			...
			<tr><td><label style="color: white">MCA Lecturer</label></td>
				<td><label style="font-family: serif; font-size: 30px;"><?php echo $mcas_count?></label></td>
			</tr>
		</table>
		...
		<table style=" background:  dodgerblue">
			...
			<tr><td><label style="color: white">Staff Notice</label></td>
		...
		<table style=" background:  tomato">
			...
			<tr>	<td><label style="color: white">Students Notice</label></td>
		...
		<table style=" background:  lightgray">
			<tr>
				<td><img src="../images/complaint.png" ></td>
				
			</tr>
			<tr><td><label style="color: white">Complaints</label></td>
