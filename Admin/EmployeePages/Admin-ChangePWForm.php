...
<div class="border">
    <div class="form">
               <h1 style="margin-left: -60%; margin-top: 15px; font-family: serif;">Change Password</h1>
                ...
                <form action="#" method="POST" onSubmit="return validateForm(this,arrFormValidation);" enctype="multipart/form-data" id="form2">
                  <table width="70%" border="0" cellspacing="0" cellpadding="0">
                    ...
                    <td><div style="position: relative; margin-top: 50px; margin-left: 220px;  float: left;" align="center">
