...
{ 
  ...
  $status = "Pending";
     ...
     $query = "Insert into staff_notice_box values('$Notice_id','$date','$Ntitle','$Nsubject','$NDesc','$status')";
...
<div class="border">
    <div class="form">
               ...
               <h1 style="margin-left: 0%; margin-top: 15px; font-family: serif;">Add New Notice Information To Employee</h1>
                  ...
                  <table width="78%" border="0" cellspacing="0" cellpadding="0">
                    ...
                    <tr>
                      ...
                      <td><span id="sprytextfield1">
                          <input type="text" name="txt_emp_title" id="txt_emp_title" placeholder=" New Title"  onkeypress="return(event.charCode >= 65  && event.charCode <= 123) || event.keyCode == 32"></span>
                      </td>
                    </tr>
                    <tr>
                      <td><label>Subject</label></td>
                      <td><span id="sprytextfield2">
                      <input type="text" name="txt_emp_tsub" id="txt_emp_tsub"  o onkeypress="return(event.charCode >= 65  && event.charCode <= 123) || event.keyCode == 32" placeholder="Subject" />
                      </span></td>
                    </tr>
              ...
              <form  name="form1" id="form1" method="POST"> 
                  <?php
                  $list =  "select * from staff_notice_box";
                ...
                ?>
                  ...
                  while($field = mysqli_fetch_assoc($check))
                  {
                    echo " <tr>
                          ...
                          <td><a href = 'UpdateEmpNotice.php?id=".$field['Notice_ID']."'>Edit</a></td>
                          <td><a href = 'DeleteEmpNotice.php?id=".$field['Notice_ID']."'>Delete</a></td>
                          </tr>";
...
if(isset($_POST['Delete']))
{
  ...
  while(list ($key,$var) = @each($ID))
  {
     $Delete = "delete * from staff_notice_box where Notice_ID='$var'";
    $delete_sql = mysqli_query($conn, $Delete);
    if($Delete)
    {
    echo'<script type="text/JavaScript1">alert("Notice Deleted Successfully!.....")window.location=\'M-Emp-Notice.php\';</script>';
    }
    else
    {
      echo'<script type="text/JavaScript1">alert("Sorry!  Unable to delete Notice.....")window.location=\'M-Emp-Notice.php\';</script>';
   }
}
}
?>
