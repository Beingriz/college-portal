    ...
    <div class="form">
      <form action="#" method="POST" onSubmit="return validateForm(this,arrFormValidation);" enctype="multipart/form-data" id="form2">
          ...
          <table width="100%" border="0" cellspacing="0" cellpadding="0">
 					  ...
 					  <h1 style="">Update Employee Details</h1>
              <tr>
                ...
                <td><span >
                <input type="text" name="txt_emp_name" id="txt_emp_name" placeholder="Enter Name" />
                </span></td>
            ...
            <h1>Update Details</h1>
                    <tr> 
                      ...
                      <td><span id="sprytextfield1">
                          <input type="text" name="txt_emp_name"  onkeypress="return event.charCode >= 65 && event.charCode <= 120"id="txt_emp_name" value="<?php echo $fields['Name'];?>"></span>
                      </td>
                      <td><label>DOB</label></td>
                      <td><span id="sprytextfield2">
                        <input type="date" name="txt_emp_dob" id="txt_emp_dob" value="<?php echo $fields['DOB'];?>">
                        </span></td>
                    
                      <td><label>Mobile: </label></td>
                      <td><span id="sprytextfield3">
                      <input type="text" name="txt_emp_no" onkeypress="return event.charCode >= 48 && event.charCode <= 57" maxlength="10" id="txt_emp_no" value="<?php echo $fields['Mobile_no'];?>" />
                      </span></td>
                    </tr>
                    <tr>
                      <td> <label>Email:</label></td>
                      <td><span id="sprytextfield4">
                      <input type="text" name="txt_emp_email" id="txt_emp_email" value="<?php echo $fields['Email'];?>" />
                      </span></td>
                      <td><label>Address:</label></td>
                      <td><span id="sprytextarea5">
                        <textarea name="txt_emp_add" id="txt_emp_add" cols="40" rows="3" value="<?php echo $fields['Adress'];?>"></textarea></span>
                       </td><td><label>Country:</label></td>
                    ...
                    <tr>
                            ...
                            <td><select name="slct_emp_state" class="form-control states" id="stateId" required="required">
                            <option value="">Select State</option>
                            <option value="<?php echo $fields['State'];?>"><?php echo $fields['State'];?>"</option>
                            </select></td>
                    
                     <td><label>City:</label></td>
                        <td><select name="slct_emp_city" class="form-control cities" id="cityId" required="required">
                            <option value="">Select City</option>
                          <option value="<?php echo $fields['City'];?>"><?php echo $fields['City'];?></option>
                            </select></td>
                          <td><label>Pin Code: </label></td>
                      <td><span id="sprytextfield6">
                      <input type="number" name="txt_emp_pin" id="txt_emp_pin" value="<?php echo $fields['Pin_code'];?>" />
                      </span></td>
                    </tr>
                    <tr>
                      ...
                      <td><span id="sprytextfield7">
                          <input type="text" name="txt_emp_exp" id="txt_emp_exp" value="<?php echo $fields['Experience'];?>"</span>
                      </td>
                    </span></td>
                  </tr>
                      ...
                      <input type="text" name="txt_emp_other" id="txt_emp_pin" value="<?php echo $fields['other'];?>" />
                      </span></td>
...

{
	...
	$query1 = "Update  staff_reg Set Name='".$emp_name."',DOB='".$emp_dob."',Mobile_no='".$emp_no."',Email='".$emp_email."',Adress='$emp_add',State='$emp_state',City='$emp_city',Pin_code='$emp_pin',Qualification='$emp_qualifi',Specialist='$emp_spclin',Experience='$emp_exprnc',Last_job='$emp_lwa',other='$emp_othr',Department='$emp_departmet',Year='$emp_departmet_yr',Semister='$emp_departmet_sem',Subject1='$emp_departmet_sub1',Subject2='$emp_departmet_sub2' WHERE Staff_id='".$emp_reg_id."' ";

		$result = mysqli_query ($conn,$query1);

		$sql1 =  "Update login1 set Name='".$emp_name."' where User_name='".$emp_reg_id."' ";
	...
	// execute query
	 $result1 = mysqli_query($conn, $sql1);
		...
		if(!$result1)
		{
			echo '<script type="text/javascript">alert("Update Fail!.. Please try again");</script>';
		}
		elseif(!$result1)
		{
		...
		{
			echo '<script type="text/javascript">alert("Congratulations! Data Updated Successfully!..");window.location=\'UpdateEmp.php\';</script>';
		}
}
