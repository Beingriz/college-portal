...
<title>Search Employee Notice Pages</title>
...
// Specify the query to execute
    $sql = "select * from staff_notice_box where Notice_ID='$Noticeid' || Notice_Date='$Date' || Title='$title' ";
// Execute query
    ...
    {
  ?>
    <table style="border: none; margin-top: -15px; align-content: center; width: 98%;" align="center" border="1" cellspacing="0" cellpadding="0"> 
      <tr>
...
// Specify the query to execute
    $sql = "select * from staff_notice_box ";
// Execute query
    $result = mysqli_query($conn,$sql);
    $record = mysqli_num_rows($result);
  ...
  <?php
   ...
   {
    echo '<script type="text/javascript">alert("Sorry!..No Record Availabe! Please Add New Notice."); window.location=\' M-Emp-Notice.php\'</script>';
   }
