...
<body >
  ...
  $Noticeid = $_GET['id'];
  $retrive = "Select * from staff_notice_box where Notice_ID='$Noticeid'";
...
// Specify the query to execute
      $sql = "update staff_notice_box Set Title='$title', Subject='$subject', Description = '$desc' where Notice_ID ='$Noticeid' ";
// Execute query
       $result = mysqli_query($conn,$sql);
        if($result)
        {
            echo '<script type="text/javascript"> alert(" Notice Updated Successfully!... ");window.location=\'M-Emp-Notice.php\';</script>';
