                      ...
                      <section class="content">
                          <div class="post">
                              <div class="post-inner">
                                <header>
                                  <h2 style="color: yellow; width: 35%;">Report Section</h2>
                                      <div class="header">
                                        <a href="#">Departmet</a><p>|</p>
                                        <a href="#">Student</a><p>|</p>
                                      <a href="#">Staff</a><p>|</p>  
                                      </div>
                              ...
                              <div class="content-area">      
                                <div class="row1">
  		             		                <div class="column1">
    				                            <h2>Report Form is Note Yet Desing</h2><br>
                                        <h2>Please Desing Admin-ReportsForm</h2>
