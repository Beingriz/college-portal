                      ...
                      <section class="content">
                          <div class="post">
                              <div class="post-inner">
                                <header>
                                  <h2 style="color: yellow;">Search Section</h2>
                                      <div class="header">
                                        <a href="Student-SearchResult.php">Result</a><p>|</p>
                                        <a href="SearchHallticket.php">Hall Ticket</a><p>|</p>
                                        <a href="SearchNotes.php">Notes</a><p>|</p>
                                      </div>
                                      <div class="cl">&nbsp;</div>
                                </header>
                              <div class="content-area">      
                                <div class="row1">
  		             		                <div class="column1">
    				                            <?php include('SearchHomePage.php'); ?>                 
  				                            </div>
			                           </div>
                              </div>
                              </div>
