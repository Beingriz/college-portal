...
// Specify the query to execute
    $search = "select * from result Where Course='$res_course' && Year='$res_year' && Semister='$res_sem'";
...
<?php
      while($field=mysqli_fetch_assoc($sql))
      {
        ...
        <td><label><a href='downloadfile.php?file=".$field['Res_fie_path']."'>Download</a></label></td>
      </tr> ";
      }
    }
    else
