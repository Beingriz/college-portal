...
<title>Student Download Result Result</title>
...
// Specify the query to execute
    ...
    $result = "select * from Student_reg where Register_No = '$reg' && Res_Path!='No Result' ";
...
<?php
      ...
      {
        echo "<h1> Hi Mr. ".$field['First_name']." </h1>";echo "<h2 style='color:orange;text-shadow:none; '>All the Best Mr. ".$field['First_name']." Please Download Yor  '".$field['Classs']." ----  ".$field['Semister']." ' Result</h2>"; 
        echo "<tr>
        ...
        <td><label><a href='downloadfile.php?file=".$field['Res_Path']."'>Download</a></label></td>
        </tr> ";
      }
    }
    else
    {
    echo '<script type="text/javascript">alert("Sorry!...No Results Availbae For Yor Class ...");window.location=\'Download.php\';</script>'; 
    }
?>
    </table>
</form>
