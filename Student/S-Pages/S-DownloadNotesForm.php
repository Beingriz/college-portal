...
// Specify the query to execute
    ...
    $result = "select * from Student_reg where Register_No = '$reg' &&  Note_file!='No Notes' ";
...
<?php
      ...
      {
        echo "<h1> Dear  ".$field['First_name']." </h1>";echo "<h2 style='color:slateblue;text-shadow:none; '>All the Best Mr. ".$field['First_name']." Please Download Yor  '".$field['Classs']." ----  ".$field['Semister']." 'Notes</h2>"; 
        echo "<tr>
        ...
        <td><label><a href='downloadfile.php?file=".$field['Note_file']."'>Download</a></label></td>
        </tr> ";
      }
    }
    else
